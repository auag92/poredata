...
def imfilter(f_data, g_data=None, device=torch.device("cpu")):
    """
    Returns auto-correlation or cross-correlation
    """
    ndim = f_data.ndim
...
@curry
def corr_master(boundary="periodic", corrtype="auto", cutoff=None, device=torch.device("cpu"), args0=None, args1=None):
    """
    ...
    args:
        ...
        cutoff   :  radius of statistics field
    """
